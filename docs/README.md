...
- SOC QAOA: greedy/SA reach oracle optimum (θ_SH ≈ 4.26); best default QAOA is p=1/2 at 3.05; sweep best is 3.57 (p=1, λ=5) in `data/qaoa_sweep.csv`; screening split in `data/qaoa_screening.csv` (#23)
